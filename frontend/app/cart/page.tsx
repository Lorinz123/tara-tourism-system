  ...
  return (
    <div className="min-h-screen bg-[#FDFCF8] py-12 px-8">
      <div className="max-w-2xl mx-auto space-y-6">
        <h1 className="text-4xl font-serif font-black text-gray-950">
          Checkout
        </h1>

        {/* ORDER SUMMARY */}
        <div className="bg-white p-8 rounded-3xl border border-gray-200 shadow-sm">
          <h2 className="font-bold text-lg mb-6 text-gray-950">
            Order Summary
          </h2>
...
>
  <Minus size={16} />
                    ...
                    <button
  onClick={() => updateQuantity(item.id, 1)}
  className="w-8 h-8 flex items-center justify-center rounded-full bg-orange-100 text-orange-600 hover:bg-orange-200 transition"
>
  <Plus size={16} />
</button>
                  </div>
        ...
        {/* DELIVERY ADDRESS */}
        <div className="bg-white p-8 rounded-3xl border border-gray-200 shadow-sm">
          <h2 className="font-bold text-lg mb-4 text-gray-950">
            Delivery Address
          </h2>
          ...
          <input
            className="w-full p-4 border border-gray-300 rounded-xl font-bold text-gray-950 focus:ring-2 focus:ring-orange-600 outline-none"
        ...
        <div className="bg-white p-8 rounded-3xl border border-gray-200 shadow-sm">
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            {[
              ...
              <button
                key={m}
                onClick={() => setMethod(m)}
                className={`p-4 border-2 rounded-xl text-sm font-black transition ${
                  method === m
          ...
          {method === 'Credit / Debit Card' && (
            <div className="space-y-4">
              <div>
                ...
                <input
                  className="w-full p-4 border border-gray-400 rounded-xl font-bold text-gray-950 bg-white placeholder:text-gray-400 focus:ring-2 focus:ring-orange-600 outline-none"
          ...
          {method === 'Cash on Delivery' && (
            <div className="p-4 bg-yellow-50 text-yellow-800 text-sm font-bold rounded-xl border border-yellow-200">
              ...
              Our rider will collect ₱{total.toFixed(2)}.
            </div>
          )}
        </div>
